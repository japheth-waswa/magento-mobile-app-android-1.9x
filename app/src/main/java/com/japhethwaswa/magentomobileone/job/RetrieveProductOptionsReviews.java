...
public class RetrieveProductOptionsReviews extends Job {

    public static final int PRIORITY = 1;
    private String productEntityId;

    public RetrieveProductOptionsReviews(String productEntityId) {
    ...
    public void onRun() throws Throwable {
        ...
        // onRun() finishes.
        JumboWebService.serviceRetrieveProductOptionsReviews(getApplicationContext(),productEntityId);
    }
