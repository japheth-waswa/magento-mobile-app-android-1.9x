...
public class RetrieveProductGallery extends Job {

    public static final int PRIORITY = 1;
    private String productEntityId;

    public RetrieveProductGallery(String productEntityId) {
    ...
    public void onRun() throws Throwable {
        ...
        // onRun() finishes.
        JumboWebService.serviceRetrieveProductGallery(getApplicationContext(),productEntityId);
    }
